...
## Part 5b
I decided to solve the challenge of calculating the control points from some real points using linear algebra.  Here's the full math:
![Calculation](https://github.com/frankxw/qnd-tool-tutorial/blob/part5b/calc_math.png)
